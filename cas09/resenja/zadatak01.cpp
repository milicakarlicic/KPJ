...
public:
    ...
    virtual ~Student() {
        /*
         * Kako klasa Student ima pokazivacko polje podrazumijevani destruktor nije dovoljan
         * jer se u tom slucaju brise vrijednost promenljive sto je u slucaju pokazivaca adresa,
         * dok ono na sta pokazujemo ostaje u memoriji.
         */
